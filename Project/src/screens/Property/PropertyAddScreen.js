...
import RenderPropertyDataAdd from '../../components/Property/RenderPropertyDataAdd';
...
class PropertyAdd extends React.Component {
    ...
    async onGoToPin(){
        ...
        const {navigation} = this.props;
        navigation.navigate('PropertyAddLocationScreen',{ region:choosed.latlng,goBack: 'PropertyAddScreen' });
    }
    ...
    async onSuccess(){
        ...
        this._toastMessage('property saved successfull.','green');
